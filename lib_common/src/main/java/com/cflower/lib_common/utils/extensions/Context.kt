...
fun Context.toast(message: CharSequence) = DToast.makeText(this, message, Toast.LENGTH_SHORT).show()

fun Context.toast(res: Int) = DToast.makeText(this, res, Toast.LENGTH_SHORT).show()
